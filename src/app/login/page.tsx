        ...
        <section className="flex flex-col mx-5 md:w-[440px] md:h-[510px] windowXl">
          ...
          <form className="mt-[17px]">
            <input
              ...
              className="flex rounded-[15px] border-2 border-primary w-full h-[65px] font-poppins text-[16px] text-blue_500 placeholder:p-[10px] p-[15px] placeholder:text-start focus:outline-0 focus:border-primary required my-5"
            />
            <div>
              <input
                type="password"
                ...
                className="flex rounded-[15px] border-2 border-primary w-full h-[65px] font-poppins text-[16px] text-blue_500 placeholder:p-[10px] p-[15px] placeholder:text-start mt-5 focus:outline-0 focus:border-primary required my-5"
              />
            </div>
            <div className="flex my-[50px] gap-[15px] items-center">
              <input
                type="radio"
