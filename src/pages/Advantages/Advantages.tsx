      ...
      <section className="bg-white md:h-[452px] w-full flex flex-col md:p-14 gap-14">
        <div className="flex justify-center">
          <div className="border-b-4 border-secondary">
            <h1 className="leading-loose font-acme text-blue_800 text-[40px]">
              ¿Porqué Co-labora?
            </h1>
          </div>
        </div>
        <section className="flex gap-5 text-center">
          <div className="flex flex-col items-center p-3 basis-1/4">
            <img
              ...
              className="h-28 w-28"
            />
            <h2 className="text-[40px] font-acme text-primary">
              Experiencias únicas
            </h2>
            <p className="text-[18px] font-poppins text-blue_800">
